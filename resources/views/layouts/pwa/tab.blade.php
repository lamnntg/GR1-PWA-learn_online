            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="action-button-list">
                        <li>
                            <a href="{{ route('exam', ['id' => \App\Models\Subject::SUBJECT_ID_1]) }}" class="btn btn-list {{ request()->is('exam/1*') ? ' text-primary' : '' }}" >
                                <span>Tiếng Việt</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('exam', ['id' => \App\Models\Subject::SUBJECT_ID_2]) }}" class="btn btn-list {{ request()->is('exam/2*') ? ' text-primary' : '' }}">
                                <span>Toán</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('exam', ['id' => \App\Models\Subject::SUBJECT_ID_3]) }}" class="btn btn-list {{ request()->is('exam/3*') ? ' text-primary' : '' }}">
                                <span>Tiếng Anh</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('exam', ['id' => \App\Models\Subject::SUBJECT_ID_4]) }}" class="btn btn-list {{ request()->is('exam/4*') ? ' text-primary' : '' }}" >
                                <span>Khoa Học</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('exam', ['id' => \App\Models\Subject::SUBJECT_ID_5]) }}" class="btn btn-list {{ request()->is('exam/5*') ? ' text-primary' : '' }}">
                                <span>Tin Học</span>
                            </a>
                        </li>
                    ...
                    <ul class="listview image-listview flush transparent no-line">
                        <li>
                            <a href="page-chat.html" class="item">
                                <img src="{{asset("assets/img/sample/avatar/avatar7.jpg")}}" alt="image" class="image">
                                <div class="in">
